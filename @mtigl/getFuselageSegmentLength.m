function [length] = getFuselageSegmentLength(fuse_tmp, segment_tmp)
    ...
    for i_pos = 1:numel(fuse_tmp.positionings.positioning)
        if isfield(fuse_tmp.positionings.positioning{i_pos}, 'fromSectionUID') && ...
           ...
           || ...
           (strcmp(fuse_tmp.positionings.positioning{i_pos}.fromSectionUID.Text, section_from.Attributes.uID) && ...
           strcmp(fuse_tmp.positionings.positioning{i_pos}.toSectionUID.Text, section_to.Attributes.uID)) )

function [xyz_seg] = getWingSegmentVector(wing_tmp, segment_tmp)
    ...
    for i_pos = 1:numel(wing_tmp.positionings.positioning)
        if isfield(wing_tmp.positionings.positioning{i_pos}, 'fromSectionUID') && ...
           ...
           || ...
           (strcmp(wing_tmp.positionings.positioning{i_pos}.fromSectionUID.Text, section_from.Attributes.uID) && ...
           strcmp(wing_tmp.positionings.positioning{i_pos}.toSectionUID.Text, section_to.Attributes.uID)) )

function [x_pt,y_pt,z_pt] = mtiglWingGetLowerPoint(mtiglHandle, wing_index, segment_index, eta, xsi)
%MTIGLWINGGETLOWERPOINT Returns point along lower surface of wing
